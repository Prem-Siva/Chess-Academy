...
function User() {
  ...
  return (
    ...
    <div className="user-profile">
     ...
     <h1 className="card-title text-left">Welcome to your Profile!</h1>
   ...
   <div style={{color:'black',textAlign:'center',paddingBottom:'100px'}}>
  
    <Link to="/Udash"><center>DashBoard</center></Link>
